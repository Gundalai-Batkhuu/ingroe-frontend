...
export function SidebarSearch({
    ...
    return (
        <div className="flex flex-col h-full inset-y-0 border-r lg:w-[200px] xl:w-[250px] bg-gradient-to-b from-background/10 via-background/50 to-background/80 backdrop-blur-xl overflow-hidden">
