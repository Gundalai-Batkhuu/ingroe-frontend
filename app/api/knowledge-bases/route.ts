...
const knowledgeBases = [
	{
		...
		description:
			'Official style manual for Australian government writing and publishing',
	...
	},
	{
		...
		description:
			'Digital services and resources for the Northern Territory',
		category: 'Government Resources',
		engagement: 42,
		featured: false,
		...
		resources: [
			{
				...
				sources:
					'https://digitalterritory.nt.gov.au/showcase/digital-portals/territory-services'
			},
			{
	...
	},
	{
		...
		resources: [
			...
			},
			{
				...
				sources:
					'https://www.directory.gov.au/reports/geographic-diversity-reports'
			}
		]
	},
	{
		...
		description:
			'Collection of documents related to the Australian democracy',
		category: 'Education',
		engagement: 71,
		featured: true,
		...
		resources: [
			...
			},
			{
				...
				sources:
					'https://www.apsreform.gov.au/sites/default/files/resource/download/Civic%20education%20and%20democratic%20perceptions%20-%20APSC%20template%20-%20Final.pdf'
			}
		]
	},
	{
