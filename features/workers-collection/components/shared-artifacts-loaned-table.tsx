...
export function SharedArtifactsLoanedTable({ userId, searchParams }: SharedArtifactsTableProps) {
    ...
    if (!artifacts || !artifacts.shared_artifacts_loaned) return <div>No shared artifacts found</div>
    ...
    function prevPage() {
        router.push(`/shared-loaned?offset=${Math.max(0, offset - 5)}`, { scroll: false })
    }
                    ...
                    <TableBody>
                        {paginatedDocuments.map((doc: SharedDocumentLoaned) => (
                            <TableRow key={doc.document_id}>
                                ...
                                <TableCell>{doc.validity ? 'Valid' : 'Invalid'}</TableCell>
                                <TableCell>
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            <DropdownMenuItem onSelect={() => handleViewDetails(doc.document_id)}>
                                                View Details
                                            </DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
