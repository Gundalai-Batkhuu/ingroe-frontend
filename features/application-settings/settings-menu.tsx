...
export function SettingsMenu({ isNavbarExpanded, toggleNavbar }: SettingsMenuProps) {
  return (
    <>
      {isNavbarExpanded ? (
        <Button variant="ghost" className="group flex w-full items-center justify-between px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-foreground dark:text-foreground">Settings</span>
          </div>
        </Button>
      ) : (
        <Button
