...
export default function EditDatabase({ artifact }: EditDatabaseProps) {
  ...
  const handleArrayChange = (e: React.ChangeEvent<HTMLTextAreaElement>, field: keyof Artefact) => {
        ...
        <div className="grid w-full items-center gap-4">
          <div className="flex flex-col space-y-1.5">
            ...
            {isEditing ? (
              ...
              <div className="p-2 bg-secondary rounded-md">{artifact.document_name}</div>
            )}
          </div>
          <div className="flex flex-col space-y-1.5">
            ...
            {isEditing ? (
              ...
              <div className="p-2 bg-secondary rounded-md">{artifact.description}</div>
            )}
          </div>
          <div className="flex flex-col space-y-1.5">
            ...
            {isEditing ? (
              <Textarea 
                ...
                onChange={(e) => handleArrayChange(e, 'vanilla_links')}
              />
            ) : (
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            {isEditing ? (
              <Textarea 
                ...
                onChange={(e) => handleArrayChange(e, 'file_links')}
              />
            ) : (
              <div className="p-2 bg-secondary rounded-md">
