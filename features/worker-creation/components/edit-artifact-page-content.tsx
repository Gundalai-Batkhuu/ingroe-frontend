...
export default function EditArtifactPageContent({
	params,
	userId
}: EditArtifactPageContentProps) {
	const router = useRouter();
	const { artifacts, updateArtifact, removeArtifact, setSelectedArtifactId } =
		userArtifactsStore();
