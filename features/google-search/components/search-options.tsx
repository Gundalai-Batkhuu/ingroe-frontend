		...
		<div className={`w-full space-y-4 ${className}`}>
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
				<div>
						...
						<Label className="flex items-center gap-2 text-xs">
							<Checkbox
								...
								onCheckedChange={checked =>
									setCountrySpecificSearch(checked as boolean)
								}
							/>
					...
					<div className="mt-2">
						<Label htmlFor="country-selector" className="text-xs">
							Select a country
						</Label>
						<CountrySelector
							id="country-selector"
				...
				<div>
					...
					<Select
						value={searchType}
						onValueChange={value =>
							setSearchType(value as 'strict' | 'medium' | 'open')
						}
					>
				...
				<div>
					...
					>
						...
						<SelectContent>
							...
							<SelectItem value="docx" className="text-xs">
								DOCX
							</SelectItem>
						</SelectContent>
					</Select>
